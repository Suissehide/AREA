...
import Display from './ContactWidgetDisplay';
...
export default function ContactWidget(props) {
    ...
    const Change = () => {
        axios.get(`http://localhost:8080/contact?authorization=${acessToken}`) //,{header : { Authorization : "Bearer" + acessToken}})
            .then(response => {
