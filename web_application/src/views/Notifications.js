        ...
        return (
            <div className="wrapper">
                ...
                <div className="main">
                    ...
                    <div className="content notification__wrapper">
                        ...
                        <div className="notification blue">
                            <div className="info">
                                ...
                                <a href="https://goo.gl/Z83wbD" className="button">Full story</a><a href="#0"
                        ...
                        <div className="notification purple">
                            <div className="info">
                                <h1><a href="0">8 min</a> to home with a bicycle</h1>
                                <p>Bicycle 2.4 km, 8 min. Use caution - may involve errors or sections not suited for
                                    bicycling</p>
                                <a href="https://goo.gl/YbvshI" className="button">Navigate</a><a href="#0"
                                                                                                  className="button gray">Dismiss</a>
                            </div>
                            <div className="icon">
